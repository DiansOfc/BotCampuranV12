...
exports.serialize = (rzlmodz, msg) => {
    ...
    try{
        ...
        msg.quotedMsg.fromMe = msg.quotedMsg.sender === rzlmodz.user.id.split(':')[0]+'@s.whatsapp.net' ? true : false
    ...
    if (msg.key.fromMe){
        msg.sender = rzlmodz.user.id.split(':')[0]+'@s.whatsapp.net'
    }
